  ...
  return (
    <View>
      <View style={styles.topContainer}>
        ...
        <View>
          <Text style={{fontWeight: 'bold', fontSize: 18, marginHorizontal: 30}}>User Name</Text>
          <Text style={{fontSize: 14, marginHorizontal: 30}}>email@gmai.com</Text>
        </View>
        <TouchableOpacity>
...
const styles= StyleSheet.create({
  ...
  heading:{fontWeight: 'bold', fontSize: 18, marginHorizontal: 30},
  subHeading:{fontSize: 14, marginHorizontal: 30},
  topContainer:{
    height: 100,
    width: 'auto',
    // backgroundColor:'red',
